export let themeStorage = {
    ...
    moduleUpdate: function () {
        ...
        (_a = document.querySelector("#edit")) === null || _a === void 0 ? void 0 : _a.style.backgroundColor = secondaryColor;
        (_b = document.querySelector(".content-wrapper")) === null || _b === void 0 ? void 0 : _b.classList.value = `content-wrapper ${themeType}`;
        (_c = document.querySelector(".nav")) === null || _c === void 0 ? void 0 : _c.classList.value = `nav-wrapper navbar-fixed indigo-theme ${themeType}`;
        let menuItem = [...(_d = document.querySelector('.menu-btn')) === null || _d === void 0 ? void 0 : _d.childNodes];
        menuItem.forEach((el) => {
            if (el.nodeType !== 3) {
